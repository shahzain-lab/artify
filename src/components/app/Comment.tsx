        ...
        <div className={cn(
            ...
            <div className='flex items-center justify-between'>
                <div className='flex items-center gap-4'>
                    ...
                    <Typography variant='semibold' className='text-[10px] md:text-[12px] flex gap-2 text-neutral-400'><p dangerouslySetInnerHTML={{ __html: coment.title }}></p></Typography>
                    <Typography variant='medium' className="text-[11px] md:text-[12px] text-noble-black-400">{formatTimeDifference(coment.date)}</Typography>
                </div>
                <div>
                    <Image
                        src={copy}
