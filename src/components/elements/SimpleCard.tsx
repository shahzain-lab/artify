...
interface Props {
    ...
    align?: 'item-center' | 'item-between' | 'item-start' | 'item-end' | 'item-col-start' | 'item-col-between' | 'item-col-center' | 'item-col-end'
    alignSM?: 'item-center' | 'item-between' | 'item-start' | 'item-end' | 'item-col-start' | 'item-col-between' | 'item-col-center' | 'item-col-end'
} 
