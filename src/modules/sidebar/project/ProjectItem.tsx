...
const ProjectItem: FC<Props> = ({ project, index, active, setActive }) => {
    return (
        <Link href={'/project'} onClick={() => setActive(index)} className={`${active === index ? 'bg-glass-fill' : ''} hover:bg-glass-fill rounded-[8px] my-1 px-1 py-4 flex justify-between items-center`}>
