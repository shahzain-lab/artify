...
function Main() {
  return (
    <div className=" bg-white dark:bg-noble-black-800 rounded-md">
      <main className="px-2 pb-6">
        ...
        <div className="grid grid-col-1 lg:grid-cols-2 xl:grid-cols-3 gap-3">
          <div className="flex flex-col items-center gap-5 py-4 dark:text-gray-700 bg-pink-100 rounded-md">
            <Image className="rounded-md" height={200} width={220} alt="img" src={shape} />
            <main className="flex justify-between gap-10">
              <span className="flex flex-col items-center">
                <span className="font-semibold xl:text-lg">Latest Uploades</span>
          ...
          <div className="grid md:px-2 gap-2 dark:text-gray-600">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-gray-100 rounded-lg items-center flex flex-col py-4">
                ...
                <h3 className="font-semibold md:text-base xl:text-lg">Latest Media</h3>
              ...
              <div className="bg-blue-900 shadow-2xl rounded-lg text-white flex flex-col items-center py-4">
                ...
                <h3 className="font-semibold md:text-base xl:text-lg">Urgent to do</h3>
        ...
        <div>
          ...
          <div className="grid grid-col-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
            ...
            {/*  */}
            <div>
              <div className="bg-pink-200 shadow-2xl border-[20px]  border-orange-400  justify-center items-center flex xl:h-[265px] xl:w-[265px] text-center w-[330px] h-[330px] rounded-[100%] dark:text-black py-5">
