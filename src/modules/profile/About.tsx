      ...
      <div className='h-60 w-full flex justify-between items-start bg-[#c892fe47] rounded-xl shadow-md'>
        ...
        <div className='flex items-center h-full mr-24 gap-7 p-4'>
          <div className='flex flex-col gap-2 items-center'>
            ...
            <Typography className='text-sm dark:text-noble-black-200 text-black'>Projects</Typography>
          </div>
          <div className='border-l dark:border-gray-300 border-gray-300 w-1 h-[60px]'></div>
          <div className='flex flex-col gap-2 items-center'>
            <Typography className='text-4xl font-bold'>52</Typography>
            <Typography className='text-sm dark:text-noble-black-200 text-black'>Leads</Typography>
          </div>
