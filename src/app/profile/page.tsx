                ...
                <div className='h-20 py-1 relative bg-noble-black-600 rounded-xl -mb-10'>
                    ...
                    <div className='pl-40 flex flex-col gap-2'>
                        ...
                        <div className='flex gap-5'>
                            <Typography className='text-[12px] text-noble-black-200 flex items-center gap-1'><Dribble color='#ccc' className='w-3 h-3' /> UX Designer</Typography>
                            <Typography className='text-[12px] text-noble-black-200 flex items-center gap-1'><DollarSign color='#ccc' className='w-3 h-3' /> 15k</Typography>
                            <Typography className='text-[12px] text-noble-black-200 flex items-center gap-2'><Level color='#ccc' className='w-3 h-3' /> Level 2</Typography>
                        </div>
                    </div>
                </div>
            </SimpleCard>
